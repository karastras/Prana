        ...
        <div className='findUs'> 
                ...
                <div className='findUs-content'>
                    ...
                    <div className='findUs-informations'>
                        ...
                        <address className='findUs-phone'>
                            Téléphone: <a href="tel:0389274528">03 89 27 45 28</a>
                        </address>
                        ...
                        <div className='findUs-follow'>
                            ...
                            <div>(En cliquant sur l'icône ci-dessus vous allez être dirigé vers une page externe au site)</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='findUs-right'>
                <div className='findUs-map'>
                    ...
                    width="600" height="470" allowfullscreen="" loading="lazy"></iframe>

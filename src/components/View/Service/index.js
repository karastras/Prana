...
import skinCare01 from '../../../assets/service/card/skinCare01.jpg';
            ...
            <div className='service-content'>
                    ...
                    <Link className='service-link' to="/epilation">
                        <Card className='service-card' >
                            ...
                            <Card.Body className='service-body'>
                                <Card.Title className='service-titles' >Epilation</Card.Title>
                ...
                <div className="service-cards">
                    <Link className='service-link' to="/skinCare">
                        <Card className='service-card' >
                            <Card.Img className='service-img' variant="top" src={skinCare01} />
                            <Card.Body className='service-body'>
                                <Card.Title className='service-titles' >Prendre soin de sa peau </Card.Title>
                                <Card.Text className='service-text'>
                                    Modelage du dos, cuir chevelu, soins des mains et des pieds, maquillage,...
                                </Card.Text>
                                    <button className='service-button'>Consulter</button>
                            </Card.Body>
                        </Card>
                ...
                <div className="service-cards">
                    <Link className='service-link' to="/bodyCare">
                        <Card className='service-card' >
                            ...
                            <Card.Body className='service-body'>
                                <Card.Title className='service-titles' >Chouchouter son corps</Card.Title>
                                <Card.Text className='service-text'>
                ...
                <div className="service-cards">
                    <Link className='service-link' to="/massage">
                        <Card className='service-card' >
                            ...
                            <Card.Body className='service-body'>
                                <Card.Title className='service-titles' >Massage</Card.Title>
                                <Card.Text className='service-text'>
